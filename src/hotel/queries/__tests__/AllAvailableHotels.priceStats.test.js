...
beforeEach(() => {
  ...
  BookingComApiMock.onGet(
    'https://distribution-xml.booking.com/2.0/json/hotelAvailability?city_ids=-2140205&checkin=2017-11-16&checkout=2017-11-23&currency=NOK&rows=1&room1=A&order_dir=desc&order_by=price&offset=0',
  ).replyWithData({
    result: [{ hotel_id: 2086794, hotel_currency_code: 'NOK', price: 2222 }],
  });
  BookingComApiMock.onGet(
    'https://distribution-xml.booking.com/2.0/json/hotelAvailability?city_ids=-2140205&checkin=2017-11-16&checkout=2017-11-23&currency=NOK&rows=1&room1=A&order_dir=asc&order_by=price&offset=0',
  ).replyWithData({
